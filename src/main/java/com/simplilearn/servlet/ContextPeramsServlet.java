...
/**
 * Servlet implementation class ContextPeramsServlet
 */
@WebServlet("/ContextPeramsServlet")
public class ContextPeramsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ContextPeramsServlet() {
        super();
